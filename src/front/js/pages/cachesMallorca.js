    ...
    return (
        ...
        <div className="cuerpo">
            ...
            <div className="container mx-auto text-center">
                <h2 className="text-center mt-5 my-4">Accede a los Cachés más Populares de la provincia de Palma de Mallorca</h2>
