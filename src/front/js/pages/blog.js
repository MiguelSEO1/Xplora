    ...
    return (
        ...
        <div>
            ...
            <div className=" cuerpo container">
                <h1 className="text-center mt-5 mb-4">Bienvenido al Blog de Geocaching</h1>
            ...
            <div className="container ">
                ...
                <div className="container-fluid mt-2 mb-5 row row-cols-lg-4 g-3 ">
                    <div className=" card text-bg-dark border-0">
                        <Link to="/como-empezar-a-buscar-caches-Guia-para-principiantes"  onClick={() => window(0, 0)} className="text-decoration-none">
                    ...
                    <div className=" card text-bg-dark border-0">
                        <Link to="/como-involucrar-a-los-mas-pequenos-en-la-busqueda-de-caches" onClick={() => window(0, 0)} className="text-decoration-none">
                    ...
                    <div className="col card text-bg-dark border-0">
                        <Link to="/como-crear-un-cache-Consejos-y-trucos" onClick={() => window(0, 0)} className="text-decoration-none">
                    ...
                    <div className=" card text-bg-dark border-0">
                        <Link to="/las-mejores-herramientas-para-la-busqueda-de-caches" onClick={() => window(0, 0)} className="text-decoration-none">
                    ...
                    <div className=" card text-bg-dark border-0">
                        <Link to="/los-caches-mas-impresionantes-y-raros-del-mundo" onClick={() => window(0, 0)} className="text-decoration-none">
                    ...
                    <div className="col card text-bg-dark border-0">
                        <Link to="/como-mantenerse-seguro-durante-la-busqueda-de-caches" onClick={() => window(0, 0)} className="text-decoration-none">
                    ...
                    <div className=" card text-bg-dark border-0">
                        <Link to="/como-resolver-enigmas-en-caches-consejos-y-trucos" onClick={() => window(0, 0)} className="text-decoration-none">
                    ...
                    <div className="col card text-bg-dark border-0">
                        <Link to="/como-encontrar-caches-en-entornos-urbanos"onClick={() => window(0, 0)}  className="text-decoration-none">
